...
export function CashesFilter({ listLoading }) {
  // Cashes UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(cashesUIProps.queryParams, values);
    if (!isEqual(newQueryParams, cashesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      cashesUIProps.setQueryParams(newQueryParams);
    }
  };
