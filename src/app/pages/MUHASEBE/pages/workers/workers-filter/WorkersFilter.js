...
export function WorkersFilter({ listLoading }) {
  // Workers UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(workersUIProps.queryParams, values);
    if (!isEqual(newQueryParams, workersUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      workersUIProps.setQueryParams(newQueryParams);
    }
  };
