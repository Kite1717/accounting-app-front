...
// Validation schema
const OutgoingEBillEditSchema = Yup.object().shape({
  fullName: Yup.string()
...
export function OutgoingEBillEditForm({
  saveOutgoingEBill,
  outgoingEBill,
  actionsLoading,
  onHide,
  ...
  return (
    <>
      <Formik
        ...
        initialValues={outgoingEBill}
        validationSchema={OutgoingEBillEditSchema}
        onSubmit={(values) => {
          saveOutgoingEBill(values);
        }}
      >
