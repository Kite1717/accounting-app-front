...
export function CustomerCategoriesFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(
      customerCategoriesUIProps.queryParams,
      values
    );
    if (!isEqual(newQueryParams, customerCategoriesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      customerCategoriesUIProps.setQueryParams(newQueryParams);
    }
  };
