...
// Validation schema
const CustomerCategoryEditSchema = Yup.object().shape({
  customerCategoryName: Yup.string().required("Zorunlu Alan"),
...
export function CustomerCategoryEditForm({
  ...
  useEffect(() => {
    setOpenStock(customerCategory.stockTracking);
  }, [customerCategory]);
  ...
  return (
    <>
      <Formik
        ...
        validationSchema={CustomerCategoryEditSchema}
        onSubmit={(values) => {
