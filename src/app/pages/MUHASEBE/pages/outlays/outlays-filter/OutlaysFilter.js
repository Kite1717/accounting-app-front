...
export function OutlaysFilter({ listLoading }) {
  // Outlays UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(outlaysUIProps.queryParams, values);
    if (!isEqual(newQueryParams, outlaysUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      outlaysUIProps.setQueryParams(newQueryParams);
    }
  };
