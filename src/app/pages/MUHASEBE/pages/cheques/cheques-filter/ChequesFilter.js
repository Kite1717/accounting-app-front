...
export function ChequesFilter({ listLoading }) {
  // Cheques UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(chequesUIProps.queryParams, values);
    if (!isEqual(newQueryParams, chequesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      chequesUIProps.setQueryParams(newQueryParams);
    }
  };
