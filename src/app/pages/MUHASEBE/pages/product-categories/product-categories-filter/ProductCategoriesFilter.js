...
export function ProductCategoriesFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(
      productCategoriesUIProps.queryParams,
      values
    );
    if (!isEqual(newQueryParams, productCategoriesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      productCategoriesUIProps.setQueryParams(newQueryParams);
    }
  };
