...
export function OutlayDocumentsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(
      outlayDocumentsUIProps.queryParams,
      values
    );
    if (!isEqual(newQueryParams, outlayDocumentsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      outlayDocumentsUIProps.setQueryParams(newQueryParams);
    }
  };
